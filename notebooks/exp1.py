...
mlflow.set_tracking_uri("https://dagshub.com/SirIsaac96/mlops-project.mlflow")  # URL to track the experiment
...
n_estimators = 100  # Number of trees in the Random Forest (with its default value)

# Start a new MLflow run for tracking the experiment
with mlflow.start_run():

    # Initialize and train the Random Forest model (with default estimators)
    ...
    mlflow.log_artifacts("RandomForestClassifier", artifact_path="model")
